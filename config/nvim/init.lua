...
vim.keymap.set('n', '<leader>q', '<CMD>:q<CR>', { desc = 'Move focus to the upper window' })
    ...
    init = function()
      require('ayu').setup {
        ...
        overrides = {
          ...
          ['@type'] = { fg = '#39BAE6' },
          ['@type.cpp'] = { fg = '#39BAE6' },
          ['@type.builtin.cpp'] = { fg = '#39BAE6' },
          ['@parameter'] = { fg = '#FFFFFF' },
          ['@parameter.cpp'] = { fg = '#FFFFFF' },
          ['@variable.parameter'] = { fg = '#FFFFFF' },
          ['@punctuation.bracket'] = { fg = '#FFFFFF' },
          ['@lsp.type.parameter'] = { fg = '#FFFFFF' },
          ['@punctuation.special.cpp'] = { fg = '#FF9427' }, -- asterisk in cpp
        },
      }
